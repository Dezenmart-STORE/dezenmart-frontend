...
const ViewTrade = () => {
  ...
  const handleNotifyMe = useCallback(() => {
    try {
      localStorage.setItem(
        "p2p-notify-preference",
        JSON.stringify({
          enabled: true,
          timestamp: Date.now(),
        })
      );
      console.log("User subscribed to P2P notifications");
    } catch (error) {
  ...
  return (
    <div className="bg-Dark min-h-screen text-white relative">
      ...
      {showComingSoon && (
        <ComingSoonOverlay
          title="Enhanced P2P Trading"
          description="Advanced features for real-time trading with live sellers are being prepared for you."
          features={[
